...
def V6e_v002(gitr_geometry_filename='gitrGeometry1v.cfg', \
                                    ...
                                    solps_rz = 'assets/geom-SAS1V/solps_rz.txt', \
    ...
    manual_indices = np.zeros(int(118/2), dtype=int)
    i=1
    ...
    manual_indices = np.append(manual_indices, range(90,118))
    ...
    plt.close()
    plt.plot(r_final, z_final, linewidth=0.1, label='V1e_v002')
    ...
    inDir[1:11] = inDir[15:17] = inDir[21] = inDir[23] = inDir[93] = -1
    inDir[91] = inDir[89] = inDir[87] = inDir[85] = inDir[83] = inDir[81] = inDir[76:79] = -1
    inDir[53:66] = -1
    ...
    W_indices = np.array(range(39,54))
    ...
    print('created gitrGeometry1v.cfg')

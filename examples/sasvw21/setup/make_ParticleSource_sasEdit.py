...
def get_surf_profiles(profilesFile, r1, z1, r2, z2, q, plot_variables):
    ...
    r_mesh = profiles.variables['r_inner_target'][:]
    z_mesh = profiles.variables['z_inner_target'][:]
...
r_W=np.loadtxt('assets/PartSourceValsEdit/r_W.txt', dtype=float)
z_W=np.loadtxt('assets/PartSourceValsEdit/z_W.txt', dtype=float)
rCoarse=np.loadtxt('assets/PartSourceValsEdit/rCoarse.txt', dtype=float)
zCoarse=np.loadtxt('assets/PartSourceValsEdit/zCoarse.txt', dtype=float)
addedPoints=100

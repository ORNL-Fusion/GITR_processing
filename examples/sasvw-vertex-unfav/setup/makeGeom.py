...
def generate_core_leakage_boundary(bFile = '../input/bField.nc'):
    ...
    pathx = v[:,0]
    pathy = v[:,1]
    core_boundary_x_fine = pathx #np.append(pathx[:791],pathx[1499:])
    core_boundary_y_fine = pathy #np.append(pathy[:791],pathy[1499:])
...
if __name__ == "__main__":
    main(use_core_leakage_boundary = 1, plot_variables = 1)
